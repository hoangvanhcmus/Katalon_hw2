...
WebUI.click(findTestObject('Object Repository/Page_Town Square - test Mattermost/span_Edit'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Town Square - test Mattermost/input_Current Password_currentPassword'), 
    curpwd)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Town Square - test Mattermost/input_New Password_newPassword'), 
    newpwd)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Town Square - test Mattermost/input_Retype New Password_confirmPassword'), 
    newpwd1)

WebUI.click(findTestObject('Object Repository/Page_Town Square - test Mattermost/span_Save'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - test Mattermost/label_Your password must contain between 5 _b964be'))
