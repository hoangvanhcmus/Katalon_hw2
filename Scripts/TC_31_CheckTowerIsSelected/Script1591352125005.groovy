...
WebUI.click(findTestObject('Object Repository/31/Page_ Town Square - aaaaaaaaaa Mattermost/div_te'))

def css_color = WebUI.getCSSValue(findTestObject('31/Page_ Town Square - test_1612115 Mattermost/a_Town Square'), 'color')
