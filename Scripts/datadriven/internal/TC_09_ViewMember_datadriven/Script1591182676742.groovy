...
WebUI.click(findTestObject('Object Repository/Page_Town Square - test Mattermost/span_View Members'))

WebUI.setText(findTestObject('Page_Town Square - test Mattermost/input_Search users_searchUsersInput'), username)
