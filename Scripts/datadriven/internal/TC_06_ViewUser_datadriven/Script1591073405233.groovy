...
WebUI.click(findTestObject('Object Repository/Page_vanhoang - test Mattermost/svg'))

WebUI.click(findTestObject('Object Repository/Page_vanhoang - test Mattermost/span_System Console'))

WebUI.click(findTestObject('Object Repository/Page_System Console - Mattermost/span_Users'))
