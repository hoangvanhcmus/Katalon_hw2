...
WebUI.click(findTestObject('Object Repository/Page_Town Square -  Mattermost/button_vanhoang_CENTER_button_rc47oqkyfjf19_a649bf'))

WebUI.click(findTestObject('Object Repository/Page_Town Square -  Mattermost/span_Delete'))
