...
if (findTestObject('Page_ Town Square - aaaaaaaaaa Mattermost/label_Never')) {
    WebUI.click(findTestObject('Page_ Town Square - aaaaaaaaaa Mattermost/label_Never'))
}

if (findTestObject('Object Repository/Page_ Town Square - aaaaaaaaaa Mattermost/label_Only for mentions and direct messages')) {
    WebUI.click(findTestObject('Object Repository/Page_ Town Square - aaaaaaaaaa Mattermost/label_Only for mentions and direct messages'))
}

WebUI.click(findTestObject('Object Repository/Page_ Town Square - aaaaaaaaaa Mattermost/span_Save'))
